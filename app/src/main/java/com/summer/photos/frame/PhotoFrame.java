 ...
 *
 */
package com.summer.photos.frame;
...
public class PhotoFrame {
     ...
     * 添加相框资源
     *
     * @param frame_around_left_top     :左上
     * @param frame_around_left         :左
     * @param frame_around_left_bottom  :左下
     * @param frame_around_bottom       :下
     * @param frame_around_right_bottom :右下
     * @param frame_around_right        :右
     * @param frame_around_right_top    :右上
     * @param frame_around_top          :上
     */
     ...
     * 添加相框资源
     *
     * @param mList 小资源图片路径列表(说明: 图片顺序为:左上，左，左下，下，右下，右，右上，上)
     */
